    ...
    inner class Acceptor : KSVisitorVoid() {
        ...
        override fun visitFunctionDeclaration(function: KSFunctionDeclaration, data: Unit) {
            codeGenerator.createNewFile(
                ...
                out.appendLine("import net.derfruhling.html.ktor.server.respondCompose")
                out.appendLine("import net.derfruhling.html.ktor.server.pageFunctionName")
                out.appendLine("import net.derfruhling.html.ktor.server.currentCall")
